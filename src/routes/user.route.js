...
import { getCurrentUser, logoutUser, refreshToken, resetPassword, updateAvatar, updateCover, updateUserInfo, userChannelProfile, userLogin, userRegister, watchHistory } from "../controllers/user.controller.js";
